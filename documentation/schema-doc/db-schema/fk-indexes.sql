...
--missed index on QRTZ_TRIGGERS table for SYS_C008643 constraint
...
--missed index on RHNPUSHCLIENT table for SYS_C007860 constraint
...
--missed index on RHNSERVERGROUP_LOG table for SYS_C008619 constraint
create index fk_no_index_149 on RHNSERVERGROUP_LOG (LOG_ID);

--missed index on RHNSERVERPACKAGE table for SYS_C008151 constraint
create index fk_no_index_150 on RHNSERVERPACKAGE (NAME_ID);

--missed index on RHNSERVERPACKAGE table for SYS_C008152 constraint
create index fk_no_index_151 on RHNSERVERPACKAGE (EVR_ID);

--missed index on RHNSERVERPACKAGE table for SYS_C008153 constraint
...
--missed index on RHNSERVER_LOG table for SYS_C008611 constraint
...
--missed index on WEB_CONTACT_LOG table for SYS_C008599 constraint
