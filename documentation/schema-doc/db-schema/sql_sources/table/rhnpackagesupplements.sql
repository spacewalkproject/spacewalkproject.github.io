...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "SPACEUSER"."RHNPACKAGESUPPLEMENTS"
  ...
  ALTER TABLE "SPACEUSER"."RHNPACKAGESUPPLEMENTS" ADD CONSTRAINT "RHN_PKG_SUPP_PACKAGE_FK" FOREIGN KEY ("PACKAGE_ID")
	  REFERENCES "SPACEUSER"."RHNPACKAGE" ("ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "SPACEUSER"."RHNPACKAGESUPPLEMENTS" ADD CONSTRAINT "RHN_PKG_SUPP_CAPABILITY_FK" FOREIGN KEY ("CAPABILITY_ID")
