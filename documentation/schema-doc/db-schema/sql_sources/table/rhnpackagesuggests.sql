...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  ALTER TABLE "SPACEUSER"."RHNPACKAGESUGGESTS" ADD CONSTRAINT "RHN_PKG_SUGG_PACKAGE_FK" FOREIGN KEY ("PACKAGE_ID")
	  REFERENCES "SPACEUSER"."RHNPACKAGE" ("ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "SPACEUSER"."RHNPACKAGESUGGESTS" ADD CONSTRAINT "RHN_PKG_SUGG_CAPABILITY_FK" FOREIGN KEY ("CAPABILITY_ID")
