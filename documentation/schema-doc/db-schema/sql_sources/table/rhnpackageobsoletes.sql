...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "SPACEUSER"."RHNPACKAGEOBSOLETES"
  ...
  ALTER TABLE "SPACEUSER"."RHNPACKAGEOBSOLETES" ADD CONSTRAINT "RHN_PKG_OBSOLETES_PACKAGE_FK" FOREIGN KEY ("PACKAGE_ID")
	  REFERENCES "SPACEUSER"."RHNPACKAGE" ("ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "SPACEUSER"."RHNPACKAGEOBSOLETES" ADD CONSTRAINT "RHN_PKG_OBSOLETES_CAP_FK" FOREIGN KEY ("CAPABILITY_ID")
