...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "SPACEUSER"."RHNPACKAGEREQUIRES"
  ...
  ALTER TABLE "SPACEUSER"."RHNPACKAGEREQUIRES" ADD CONSTRAINT "RHN_PKG_REQUIRES_PACKAGE_FK" FOREIGN KEY ("PACKAGE_ID")
	  REFERENCES "SPACEUSER"."RHNPACKAGE" ("ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "SPACEUSER"."RHNPACKAGEREQUIRES" ADD CONSTRAINT "RHN_PKG_REQUIRES_CAPABILITY_FK" FOREIGN KEY ("CAPABILITY_ID")
