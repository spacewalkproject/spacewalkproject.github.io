...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "SPACEUSER"."RHNPACKAGERECOMMENDS"
  ...
  ALTER TABLE "SPACEUSER"."RHNPACKAGERECOMMENDS" ADD CONSTRAINT "RHN_PKG_REC_PACKAGE_FK" FOREIGN KEY ("PACKAGE_ID")
	  REFERENCES "SPACEUSER"."RHNPACKAGE" ("ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "SPACEUSER"."RHNPACKAGERECOMMENDS" ADD CONSTRAINT "RHN_PKG_REC_CAPABILITY_FK" FOREIGN KEY ("CAPABILITY_ID")
