...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "SPACEUSER"."RHNPACKAGEBREAKS"
  ...
  ALTER TABLE "SPACEUSER"."RHNPACKAGEBREAKS" ADD CONSTRAINT "RHN_PKG_BRKS_PACKAGE_FK" FOREIGN KEY ("PACKAGE_ID")
	  REFERENCES "SPACEUSER"."RHNPACKAGE" ("ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "SPACEUSER"."RHNPACKAGEBREAKS" ADD CONSTRAINT "RHN_PKG_BRKS_CAPABILITY_FK" FOREIGN KEY ("CAPABILITY_ID")
