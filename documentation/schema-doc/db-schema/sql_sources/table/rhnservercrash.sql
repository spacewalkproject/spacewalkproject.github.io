...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  ALTER TABLE "SPACEUSER"."RHNSERVERCRASH" ADD CONSTRAINT "RHN_SERVER_CRASH_ID_PK" PRIMARY KEY ("ID") ENABLE;
  ALTER TABLE "SPACEUSER"."RHNSERVERCRASH" ADD CONSTRAINT "RHN_SERVER_CRASH_SID_FK" FOREIGN KEY ("SERVER_ID")
	  REFERENCES "SPACEUSER"."RHNSERVER" ("ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "SPACEUSER"."RHNSERVERCRASH" ADD CONSTRAINT "RHN_SERVER_CRASH_PNAME_ID_FK" FOREIGN KEY ("PACKAGE_NAME_ID")
	  REFERENCES "SPACEUSER"."RHNPACKAGENAME" ("ID") ENABLE;
  ALTER TABLE "SPACEUSER"."RHNSERVERCRASH" ADD CONSTRAINT "RHN_SERVER_CRASH_EVR_ID_FK" FOREIGN KEY ("PACKAGE_EVR_ID")
	  REFERENCES "SPACEUSER"."RHNPACKAGEEVR" ("ID") ENABLE;
  ALTER TABLE "SPACEUSER"."RHNSERVERCRASH" ADD CONSTRAINT "RHN_SERVER_CRASH_ARCH_ID_FK" FOREIGN KEY ("PACKAGE_ARCH_ID")
