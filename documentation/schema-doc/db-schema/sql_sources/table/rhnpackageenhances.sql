...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE TABLE "SPACEUSER"."RHNPACKAGEENHANCES"
  ...
  ALTER TABLE "SPACEUSER"."RHNPACKAGEENHANCES" ADD CONSTRAINT "RHN_PKG_ENH_PACKAGE_FK" FOREIGN KEY ("PACKAGE_ID")
	  REFERENCES "SPACEUSER"."RHNPACKAGE" ("ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "SPACEUSER"."RHNPACKAGEENHANCES" ADD CONSTRAINT "RHN_PKG_ENH_CAPABILITY_FK" FOREIGN KEY ("CAPABILITY_ID")
