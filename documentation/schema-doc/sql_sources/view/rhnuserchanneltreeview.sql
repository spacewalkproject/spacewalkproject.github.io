...
-- visit http://www.yarpen.cz/oraschemadoc/ for more info
  ...
  CREATE OR REPLACE FORCE VIEW "SPACEUSER"."RHNUSERCHANNELTREEVIEW" ("USER_ID", "ORG_ID", "ID", "DEPTH", "NAME", "PADDED_NAME", "CHANNEL_ARCH_ID", "LAST_MODIFIED", "LABEL", "PARENT_OR_SELF_LABEL", "PARENT_OR_SELF_ID", "END_OF_LIFE") AS 
